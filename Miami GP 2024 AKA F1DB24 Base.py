...
Race = ff1.get_session(2024, 'Miami', 'Race')
...
minisec.to_sql('minisec_master', con=engine, if_exists='replace', index=False)
minisec_df.to_sql('minisecspeed', con=engine, if_exists='replace', index=False)